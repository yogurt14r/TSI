...
const LoginModal = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black/[0.5] z-50">
            <div className="w-[480px] h-[600px] bg-white text-black p-6 rounded-[20px] shadow-lg relative flex flex-col justify-center">
                ...
                <p className="text-[14pt] p-7">Введите номер телефона, чтобы войти или зарегистрироваться</p>
                <form>
                    <div className="mb-4">
